...
export function CompanySettingsForm({ readOnly = false }: { readOnly?: boolean }) {
  ...
  return (
    <div className="w-full space-y-6">
      <PageHeader
        title="Profil bisnis"
        description={readOnly ? "Lihat identitas dan rekening yang tampil pada invoice dan PDF. Hanya Owner yang dapat mengubah." : "Atur identitas dan rekening yang tampil pada invoice, PDF, dan halaman pelanggan."}
      />
